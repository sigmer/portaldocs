...
### **Step A** - Return an HTML page for your Blade
...
{"gitdown": "include-section", "file": "../samples/SamplesExtension/Extension/Client/V2/Blades/AzBlade/AzBladeLauncherBlade.ts", "section": "docs#ImportAzBladeReference"}
...
### **Step D** - Secure your Blade HTML pages
...
### **Step E** - Register your site's URI
...
### **Step F** - Return JSON metadata about your UI
...
### **Step G** - (Optional) Make your HTML page debuggable
...
### **Step H** - (Optional) Flighting your extension in the Portal's "mpac" environment
