...
* Use the **smartAlignLabel** option to display each label and data field on the same line.  This is commonly used in resource creation forms and other wide pages* Be concise on the navigation labels, ideally one or two words rather than a phrase.
